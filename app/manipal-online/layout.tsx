...
// ✅ Nested layout — sirf children return karo
// html aur body tags NAHI — wo root app/layout.tsx me hain
export default function ManipalLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
